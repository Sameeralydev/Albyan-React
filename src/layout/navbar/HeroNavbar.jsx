...
export default function HeroNavbar() {
  ...
  {[
    {
      name: "Facebook",
      link: "https://www.facebook.com/Albyangroupofinstitutes",
    },
    {
      name: "Instagram",
      link: "https://www.instagram.com/albyangroupofinstitutes/",
    },
    {
      name: "Youtube",
      link: "https://www.youtube.com/@AlByanGroupofinstitutes",
    },
  ].map((item) => (
    <a
      key={item.name}
